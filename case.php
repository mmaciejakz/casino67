...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const spinCost = 75; // ZMIENIONE NA 75
    ...
    function closeModalFunction() {
        ...
        // NIE resetujemy tracka - zostaje w miejscu gdzie się zatrzymał
    }
    ...
    spinBtn.addEventListener('click', function() {
        ...
        // Losujemy nowy index za każdym razem (od 20 do 45)
        const randomIndex = Math.floor(Math.random() * 26) + 20; // Losuje od 20 do 45
        const finalPrize = items[randomIndex];
        
        const itemWidth = 160;
        const offset = (randomIndex * itemWidth) - 400 + 80;
        ...
        spinTimeout = setTimeout(() => {
            // Najpierw odejmij koszt zakręcenia
            ...
            .then(deductData => {
                if (deductData.success) {
                    ...
                    throw new Error('Nie udało się odjąć środków');
                }
            })
            .then(response => response.json())
            .then(data => {
